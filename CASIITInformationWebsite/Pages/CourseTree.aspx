...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <asp:Button ID="ResetViewButton" runat="server" Text="hot pocket" style="position:absolute;left:50px;background-color:var(--button-background)" OnClientClick="pz.zoom(0.3,{animate:true});pz.pan(-1314,104,{animate:true});"/>
        </ContentTemplate>
    </asp:UpdatePanel>
