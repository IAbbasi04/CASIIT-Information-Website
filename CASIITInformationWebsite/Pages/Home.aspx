<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CASIITInformationWebsite._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <h1 style="font-size:130px; font-family:'Baskerville Old Face'; font-weight:bold; vertical-align:bottom; color:blueviolet" align="center">
        <asp:Image style="vertical-align:top" ID="CASIIT_logo" runat="server" src="../Images2/casiitlogo.png" Height="130px" Width="130px"/>
        Casiit
    </h1>

    <p style="font-size:18px; font-family:'Baskerville Old Face'; font-weight:bold; color:black; text-underline-position:from-font;" align="center">
    ...
    <div>
        <asp:Table ID="Table1" runat="server">
            <asp:TableRow BorderWidth="4px" BorderColor="Black" BackColor="BlueViolet">
    ...
    <asp:Table ID="Table3" runat="server" HorizontalAlign="Center">
            <asp:TableRow >
                <asp:TableCell >
                    <asp:Image ID="Image1" runat="server" src="../Images2/bobcat.jpg" Height="120px" Width="200px"/>
                </asp:TableCell>
                <asp:TableCell Width="280px" HorizontalAlign="Center" VerticalAlign="Middle">
                    <asp:Label ID="Label1" runat="server" Text="Label"> Visit Battlefield Website: </asp:Label>
                    <a href="https://battlefieldhs.pwcs.edu/">Click Here to Visit!</a>
                    <asp:Label ID="Label3" runat="server" Text="Label"> Visit NVCC Website: </asp:Label>
    ...
    <h2 style="color:blueviolet; font-family:'Baskerville Old Face'; font-weight:bold;" align="left">
        What is Casiit?
    </h2>
     ...
     <asp:Table ID="Table6" runat="server">
            <asp:TableRow >
                <asp:TableCell Height="125px" Width="1300px" HorizontalAlign="Left"> 
                    ...
                    <p style="color:darkgoldenrod; font-family:'Times New Roman', Times, serif">
                    ...
                    <p style="color:darkgray; font-family:'Times New Roman', Times, serif">
                    ...
                    <p style="color:sienna; font-family:'Times New Roman', Times, serif">
